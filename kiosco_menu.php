...
<header style="background-color: #5F77B7">
  ...
  <a href="#" data-target="slide-out" class="sidenav-trigger hide-on-large-only amber darken-2 white-text"><i class="material-icons medium z-depth-1">format_indent_decrease</i></a>
